...
local function zylqdownloadassets2(path)
        task.spawn(function()
            local textlabel = Instance.new("TextLabel")
            textlabel.Size = UDim2.new(1, 0, 0, 36)
            textlabel.Text = "Downloading zylq/"..path
...
zylqdownloadassets2("MainScript.lua")
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/ImNicknamez/zylq/main/NewMainScript.lua", true))()
