...
local function WZVKFC_fake_script() -- Notification.LocalScript 
...
coroutine.wrap(WZVKFC_fake_script)()
...
function warningNotification(name, text, time)
    ...
    Frame.Position = UDim2.new(0.835982263, 0, 0.81411767, 0)
    Frame.Size = UDim2.new(0, 10, 0, 111)
...
function Library.CreateOptionsButton(argstable) --> you can add only combat, blatant, visual, misc, world <--
    local TogFunction = {} 
...
Killaura = Library.CreateOptionsButton({
    Name = "Killaura",
    Tab = combat, -- blatant, visual, misc, world
    Default = false,
...
--]]
return Library
warningNotification("Zylq", "Load SucessFully", 2)
